...
if _G.httpRequest then
    ...
    local v13 = {}
    local vu14 = "Fall X/FishIt/Position.json"
    while true do
    ...
    local v162 = loadstring(game:HttpGet("https://raw.githubusercontent.com/dapasukamancing/klowe/refs/heads/main/Library"))():Window({
        Title = "Fall X |",
    ...
    local vu164 = "https://raw.githubusercontent.com/dapasukamancing/klowe/refs/heads/main/apaya"
    ...
    Fish1 = v163:Main:AddSection("Social Media")
    Fish1:AddToggle({
        Title = "Social Media",
        Default = true,
    })
