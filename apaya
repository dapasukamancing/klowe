return function(Window, Tabs)
    ...
    local InfoSection = Tabs.Info:AddSection("Fall X Information", true)

    InfoSection:AddParagraph({
        Title = "Fall X Alert!",
        Content = [[
gada apa apa jir
jangan maen di publik server, bikin private jir, gratis
<b>ke ban jangan salahin gweh</b>
]],
        Icon = "water"
    })
    ...
    InfoSection:AddParagraph({
        Title = "Fall X Tako",
        Content = "Donate Pls",
        Icon = "https://tako.id/icon.png?5d98c79febb5d013",
        ButtonText = "COPY LINK TAKO",
        ButtonCallback = function()
            if setclipboard then
                setclipboard("https://tako.id/NaufalxD")
